...
public class MessageListener extends ListenerAdapter {
    ...
    private Text formatBodyComponent(Member author, Message message) {
        ...
        Text authorComponent =
                Text.translatable("dispair.format.author", authorName)
                        .copy()
                        .setStyle(Style.EMPTY.withColor(color.getRGB()).withBold(true));
        Text bodyComponent =
                Text.of(bodyString)
                        .copy()
    ...
    private Text formatAttachmentComponent(Message.Attachment attachment) {
        ...
        Text attachmentComponent =
                Text.translatable("dispair.format.attachment", attachment.getFileName());
